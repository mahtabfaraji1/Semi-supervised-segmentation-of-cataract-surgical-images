...
exp = 'Experiment_labeled_40_per_631_labeled_e30000_portion_r_1'
model_name = 'unet'
...
seed = 1337
num_classes = 5
labeled_bs = round(0.4 * batch_size)
labeled_num = 631
ema_decay = 0.99
...
def train():
    ...
    labeled_images_file = open(os.path.join(snapshot_path, 'labeled_images_40_per.txt'), 'w')
    unlabeled_images_file = open(os.path.join(snapshot_path, 'unlabeled_images_40_per.txt'), 'w')
