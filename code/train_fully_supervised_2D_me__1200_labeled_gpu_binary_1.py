...
from dataloaders.dataset_binary import BaseDataSets, RandomGenerator
...
parser.add_argument('--root_path', type=str,
                    default='/Users/mahtab/Downloads/SSL4MIS/segmentation_project/data/1200_labeled/',
                    help='Name of Experiment')
parser.add_argument('--exp', type=str,
                    default='Exp_supervised_unet_resnet_binary_instrument', help='experiment_name')
...
parser.add_argument('--labeled_num', type=int, default=1200,
                    help='labeled data')
...
def train(args):
    ...
    batch_size_list = [2, 16, 32]
    # base_lr = 0.01
    # batch_size = 64
    for base_lr, batch_size in itertools.product( base_lr_list, batch_size_list):
        exp = f"full_supervised_experiment with base_lr={base_lr}, batch_size={batch_size},labeld_num={args.labeled_num}_model={args.model}_binary_instrument"
        print(exp)
        ...
        for epoch_num in iterator:
            ...
            for i_batch, sampled_batch in enumerate(trainloader):
                ...
                volume_batch = volume_batch.repeat(1, 3, 1, 1)  # New shape: (batch, 3, height, width)
