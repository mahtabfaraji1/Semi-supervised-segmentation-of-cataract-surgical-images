...
parser.add_argument('--exp', type=str,
                    default='Exp_supervised_unet_resnet_all_data', help='experiment_name')
...
def train(args):
    ...
    exp = f"full_supervised_experiment with base_lr={base_lr}, batch_size={batch_size},labeld_num={args.labeled_num}_model={args.model}_all_data"
    print(exp)
