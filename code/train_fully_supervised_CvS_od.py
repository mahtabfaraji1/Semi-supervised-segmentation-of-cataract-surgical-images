...
parser.add_argument('--root_path', type=str,
                    default='/home/mahtab/segmentation/SSL4MIS/segmentation_env/data/CVS_data/OD_all_data/',
...
def train(args):
    ...
    exp = f"full_supervised_experiment with base_lr={base_lr}, batch_size={batch_size},labeld_num={args.labeled_num}_model={args.model}_FIVES_HRF_e_1k_od_l_ce"
    print(exp)
