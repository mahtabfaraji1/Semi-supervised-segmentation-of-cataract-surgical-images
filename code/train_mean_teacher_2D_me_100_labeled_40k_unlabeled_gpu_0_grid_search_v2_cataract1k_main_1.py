...
def train():
    ...
    base_lr_list = [0.01]
    batch_size_list = [24]
    ema_decay_list = [0.99, 0.995, 0.999, 0.9995]
    # ema_decay_list = [0.995, 0.999, 0.9995]
    # ramp_up_list = 1000
    consistency_list = [0.1, 0.5,1, 5, 10,20,30]
    # wait_period_list = 2500
    ramp_up_list =[50,100,200,400, 600, 800, 1000]
    wait_period_list = [2000, 2500, 3000,3500, 4000]
    ...
    for base_lr, batch_size, ema_decay, consistency, ramp_up, wait_period in hyperparameter_combinations:
        ...
        exp = f"experiment with labeled={labeled_num}, unlabeled={unlabeled_num}_ema_decay={ema_decay}_consistency_{consistency}_ramp_up_{ramp_up}_wait_period_{wait_period}_cataract1k_v4_model={model_name}"
        print(exp)
