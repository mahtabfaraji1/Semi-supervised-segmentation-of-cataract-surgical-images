...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_root_dir', type=str, default= '/Volumes/ADATA HD720/PhD_UIC/SSL4MIS/segmentation_project/model_6/')
    parser.add_argument('--num_classes', type=int, default=5, help='Number of output classes')
    parser.add_argument('--patch_size', type=list, default=[256, 256], help='Patch size of network input')
    parser.add_argument('--output_dir', type=str, default= '/Volumes/ADATA HD720/PhD_UIC/SSL4MIS/segmentation_project/model_6/')
