...
parser.add_argument('--exp', type=str,
                    default='/Users/mahtab/Downloads/SSL4MIS/segmentation_project/model/experiment with labeled=300, unlabeled=10166_cataract1k_v4_300_labeled/',
                    help='experiment_name')
...
parser.add_argument('--output_dir', type=str, default='/Users/mahtab/Downloads/SSL4MIS/segmentation_project/model/experiment with labeled=300, unlabeled=10166_cataract1k_v4_300_labeled/output_ema/',
...
def Inference(FLAGS):
    ...
    with open(os.path.join(output_dir, "metric_dict_sup_600_cataract_10k.pkl"), 'wb') as file:
