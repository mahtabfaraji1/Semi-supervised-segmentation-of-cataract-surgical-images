...
root_path = '/home/mahtab/segmentation/SSL4MIS/segmentation_env/data/Catarct1k_40k/400_labeled/'
...
def train():
    ...
    for ramp_up in ramp_up_list:
        ...
        exp = f"experiment with labeled={labeled_num}, unlabeled={unlabeled_num}_ema_decay={ema_decay}_consistency_{consistency}_batch_size={batch_size}_ramp_up_{ramp_up}_wait_period_{wait_period}_cataract1k_v4_model={model_name}"
        print(exp)
