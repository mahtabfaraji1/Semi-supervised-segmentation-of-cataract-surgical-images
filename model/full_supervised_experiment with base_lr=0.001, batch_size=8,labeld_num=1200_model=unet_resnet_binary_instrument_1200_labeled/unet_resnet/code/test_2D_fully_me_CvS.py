...
parser.add_argument('--image_dir', type=str,
                    default='/Users/mahtab/Downloads/SSL4MIS/segmentation_project/data/CVS_data/all_data/test/images',
                    help='Name of Experiment')
parser.add_argument('--label_dir', type=str,
                    default='/Users/mahtab/Downloads/SSL4MIS/segmentation_project/data/CVS_data/all_data/test/labels',
                    help='experiment_name')
parser.add_argument('--exp', type=str,
                    default='/Users/mahtab/Downloads/SSL4MIS/segmentation_project/model/full_supervised_experiment with base_lr=0.0005, batch_size=32,labeld_num=553_model=unet_resnet_FIVES_HRF_e_1k_l_ce_553_labeled/',
                    help='experiment_name')
...
parser.add_argument('--output_dir', type=str, default='/Users/mahtab/Downloads/SSL4MIS/segmentation_project/model/full_supervised_experiment with base_lr=0.0005, batch_size=32,labeld_num=553_model=unet_resnet_FIVES_HRF_e_1k_l_ce_553_labeled/output_hrf_fives/',
