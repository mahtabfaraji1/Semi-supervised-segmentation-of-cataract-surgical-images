...
parser.add_argument('--exp', type=str,
                    default='Exp_supervised_Unet_800_labeled_vit', help='experiment_name')
...
def train(args):
    ...
    exp = f"full_supervised_experiment with labeld_num={args.labeled_num}_batch_size={batch_size}_lr={base_lr}_vit"
    print(exp)
