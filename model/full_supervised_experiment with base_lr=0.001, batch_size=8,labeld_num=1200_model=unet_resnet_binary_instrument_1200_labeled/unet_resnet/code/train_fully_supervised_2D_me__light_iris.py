...
parser.add_argument('--exp', type=str,
                    default='Exp_supervised_Unet_light_iris_unet_resnet_cataract', help='experiment_name')
...
def train(args):
    ...
    exp = f"full_supervised_experiment with labeled_num={args.labeled_num}_light_iris"
    print(exp)
