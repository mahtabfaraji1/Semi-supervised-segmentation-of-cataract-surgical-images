...
parser.add_argument('--label_dir', type=str,
                    default='/Users/mahtab/Downloads/SSL4MIS/segmentation_project/data/CaDISv2/test/Labels_iris_pupil_class',
                    help='experiment_name')
parser.add_argument('--exp', type=str,
                    default='/Users/mahtab/Downloads/SSL4MIS/segmentation_project/model/full_supervised_deepLab/full_supervised_experiment with base_lr=0.01, batch_size=24,labeld_num=1200_model=deeplabv3_resnet_1200_labeled/',
                    help='experiment_name')
...
parser.add_argument('--output_dir', type=str, default='/Users/mahtab/Downloads/SSL4MIS/segmentation_project/model/full_supervised_deepLab/full_supervised_experiment with base_lr=0.01, batch_size=24,labeld_num=1200_model=deeplabv3_resnet_1200_labeled/output_cadis/',
