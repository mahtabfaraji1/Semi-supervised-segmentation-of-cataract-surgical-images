...
parser.add_argument('--root_path', type=str,
                    default='/Users/mahtab/Downloads/SSL4MIS/segmentation_project/data/cataract1k/labeled/all/', help='Name of Experiment')
parser.add_argument('--exp', type=str,
                    default='Experiment_cnn_transformer_labeled_fold_0', help='experiment_name')
...
parser.add_argument(
    '--cfg', type=str, default="/Users/mahtab/Downloads/SSL4MIS/segmentation_project/code/configs/swin_tiny_patch4_window7_224_lite.yaml", help='path to config file', )
parser.add_argument(
    "--opts",
...
def train(args,snapshot_path):
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            loss_dice_cnn = dice_loss(outputs_cnn_student_soft[:args.labeled_bs], label_batch[:args.labeled_bs].unsqueeze(1))
            cnn_supervised_loss = 0.5 * (loss_dice_cnn + loss_ce_cnn)

            loss_ce_transformer = ce_loss(outputs_transformer_student[:args.labeled_bs], label_batch[:args.labeled_bs].long())
            ...
            cnn_consistency_loss = torch.mean((outputs_cnn_student_soft[args.labeled_bs:] - outputs_cnn_teacher_soft) ** 2)
            ...
            cnn_cross_loss = torch.mean((outputs_cnn_student_soft[args.labeled_bs:] - outputs_transformer_teacher_soft) ** 2)
