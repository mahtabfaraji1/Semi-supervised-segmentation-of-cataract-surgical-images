...
parser.add_argument('--exp', type=str,
                    default='/Users/mahtab/Downloads/SSL4MIS/segmentation_project/model/full_supervised_experiment with base_lr=0.01, batch_size=24,labeld_num=300_num_classes=2_300_labeled/',
                    help='experiment_name')
...
parser.add_argument('--output_dir', type=str, default='/Users/mahtab/Downloads/SSL4MIS/segmentation_project/model/full_supervised_experiment with base_lr=0.01, batch_size=24,labeld_num=300_num_classes=2_300_labeled/output_cadis/',
