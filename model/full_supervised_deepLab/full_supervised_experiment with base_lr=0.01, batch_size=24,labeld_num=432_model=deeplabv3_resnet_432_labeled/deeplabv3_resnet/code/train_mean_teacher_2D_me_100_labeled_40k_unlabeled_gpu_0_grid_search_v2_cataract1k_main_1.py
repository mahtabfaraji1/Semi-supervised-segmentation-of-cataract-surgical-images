...
def train():
    ...
    for ramp_up in ramp_up_list:
        ...
        global model_name, num_classes, max_iterations, model_name
        # define experiment name
        exp = f"experiment with labeled={labeled_num}, unlabeled={unlabeled_num}_cataract1k_v4_model={model_name}"
        print(exp)
