...
parser.add_argument('--root_path', type=str,
                    default='/Users/mahtab/Downloads/SSL4MIS/segmentation_project/data/CVS_data/FIVES_HRF/', help='Name of Experiment')
parser.add_argument('--exp', type=str,
                    default='Exp_supervised_deeplabv3_resnet_FIVES_HRF', help='experiment_name')
...
parser.add_argument('--labeled_num', type=int, default=432,
                    help='labeled data')
