...
parser.add_argument('--exp', type=str,
                    default='/Users/mahtab/Downloads/SSL4MIS/segmentation_project/model/Cadis/supervised/50_labeled/full_supervised_experiment with base_lr=0.01, batch_size=16,labeld_num=50_cadis_50_labeled/',
                    help='experiment_name')
...
parser.add_argument('--output_dir', type=str, default='/Users/mahtab/Downloads/SSL4MIS/segmentation_project/model/Cadis/supervised/50_labeled/full_supervised_experiment with base_lr=0.01, batch_size=16,labeld_num=50_cadis_50_labeled/output/',
