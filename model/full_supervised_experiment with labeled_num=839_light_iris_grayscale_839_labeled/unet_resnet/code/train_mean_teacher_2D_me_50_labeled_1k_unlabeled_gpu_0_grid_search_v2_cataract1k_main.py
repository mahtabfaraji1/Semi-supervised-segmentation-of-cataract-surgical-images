...
root_path = '/home/mahtab/segmentation/SSL4MIS/segmentation_env/data/Catarct1k_10k/600_labeled/'
...
def train():
    ...
    for ramp_up in ramp_up_list:
        ...
        exp = f"experiment with labeled={labeled_num}, unlabeled={unlabeled_num}_cataract1k_v2"
        print(exp)
