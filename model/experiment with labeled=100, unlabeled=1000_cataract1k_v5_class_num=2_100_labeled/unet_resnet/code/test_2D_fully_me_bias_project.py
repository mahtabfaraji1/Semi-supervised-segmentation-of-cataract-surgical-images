...
parser.add_argument('--label_dir', type=str, default='/Users/mahtab/Downloads/SSL4MIS/segmentation_project/data/cataract1k/labeled/all/test/labels_four_class/', help='Directory with ground truth labels_four_class')
