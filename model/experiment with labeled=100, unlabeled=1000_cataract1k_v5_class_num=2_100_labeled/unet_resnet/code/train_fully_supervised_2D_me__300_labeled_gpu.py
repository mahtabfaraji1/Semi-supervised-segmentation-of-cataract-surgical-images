...
parser.add_argument('--root_path', type=str,
                    default='/home/mahtab/segmentation/SSL4MIS/segmentation_env/data/Cataract1k/300_labeled_data_supervised/', help='Name of Experiment')
parser.add_argument('--exp', type=str,
                    default='Exp_supervised_Unet_300_labeled_unet_resnet_binary', help='experiment_name')
...
def train(args):
    ...
    exp = f"full_supervised_experiment with base_lr={base_lr}, batch_size={batch_size},labeld_num={args.labeled_num}_num_classes={num_classes}"
    print(exp)
