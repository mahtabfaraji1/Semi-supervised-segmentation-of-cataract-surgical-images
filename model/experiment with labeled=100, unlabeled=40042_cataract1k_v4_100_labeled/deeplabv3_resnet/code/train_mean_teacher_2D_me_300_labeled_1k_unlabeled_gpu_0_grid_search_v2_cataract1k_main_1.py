...
root_path = '/home/mahtab/segmentation/SSL4MIS/segmentation_env/data/Catarct1k_40k/300_labeled/'
...
def train():
    ...
    for ramp_up in ramp_up_list:
        ...
        exp = f"experiment with labeled={labeled_num}, unlabeled={unlabeled_num}_cataract1k_v5_class_num={num_classes}"
        print(exp)
