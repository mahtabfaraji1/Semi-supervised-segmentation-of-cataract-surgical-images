...
parser.add_argument('--exp', type=str,
                    default='Exp_supervised_Unet_1200_labeled_unet_resnet_2_class', help='experiment_name')
...
def train(args):
    ...
    exp = f"full_supervised_experiment with base_lr={base_lr}, batch_size={batch_size},labeld_num={args.labeled_num}_num_claas={num_classes}"
    print(exp)
