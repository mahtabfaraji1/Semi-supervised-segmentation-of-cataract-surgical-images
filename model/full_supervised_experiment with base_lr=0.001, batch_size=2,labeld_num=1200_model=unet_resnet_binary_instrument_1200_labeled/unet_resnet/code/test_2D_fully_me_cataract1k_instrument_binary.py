...
parser.add_argument('--image_dir', type=str,
                    default='/Users/mahtab/Downloads/SSL4MIS/segmentation_project/data/CaDISv2/videos/output_images',
                    help='Name of Experiment')
parser.add_argument('--label_dir', type=str,
                    default='/Users/mahtab/Downloads/SSL4MIS/segmentation_project/data/CaDISv2/videos/Labels_2_class',
                    help='experiment_name')
parser.add_argument('--exp', type=str,
                    default='/Users/mahtab/Downloads/SSL4MIS/segmentation_project/model/experiment with labeled=1200, unlabeled=40042_cataract1k_v4_num_class=2_1200_labeled/',
                    help='experiment_name')
...
parser.add_argument('--output_dir', type=str, default='/Users/mahtab/Downloads/SSL4MIS/segmentation_project/model/experiment with labeled=1200, unlabeled=40042_cataract1k_v4_num_class=2_1200_labeled/output_ema/',
