...
def train(args, snapshot_path):
    ...
    for epoch_num in iterator:
        ...
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            loss_ulb_consist, loss_ulb_conflict = torch.tensor(0.0).cpu(), torch.tensor(0.0).cpu()
            ...
            with torch.no_grad():
                if not flag_start_self_learning and not args["flag_pseudo_from_student"]:
                    ...
                    conflict_ratio = torch.tensor(0.0).cpu()
...
if __name__ == "__main__":
    ...
    parser.add_argument('--root_path', type=str,
                        default='/Users/mahtab/Downloads/SSL4MIS/segmentation_project/data/cataract1k/labeled/fold_0/', help='Name of Experiment')
    parser.add_argument('--res_path', type=str, 
                        default='/Users/mahtab/Downloads/SSL4MIS/segmentation_project/results/', help='Path to save resutls')
    parser.add_argument('--exp', type=str,
                        default='AD-MT', help='experiment_name')
    ...
    cfgs_file = args['cfg']
    cfgs_file = os.path.join('/Users/mahtab/Downloads/SSL4MIS/segmentation_project/cfg',cfgs_file)
