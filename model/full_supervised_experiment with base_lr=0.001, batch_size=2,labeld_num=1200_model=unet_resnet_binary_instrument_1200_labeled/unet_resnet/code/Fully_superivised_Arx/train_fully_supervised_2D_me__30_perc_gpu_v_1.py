...
parser.add_argument('--root_path', type=str,
                    default='/home/mahtab/segmentation/SSL4MIS/segmentation_env/data/cataract1k/30_perc/', help='Name of Experiment')
parser.add_argument('--exp', type=str,
                    default='Exp_supervised_Unet_30_percent_v_2_r2', help='experiment_name')
...
parser.add_argument('--labeled_num', type=int, default=473,
                    help='labeled data')
...
def train(args, snapshot_path):
    ...
    db_train = BaseDataSets(base_dir=args.root_path, split="train", num=args.labeled_num, transform=transforms.Compose([
