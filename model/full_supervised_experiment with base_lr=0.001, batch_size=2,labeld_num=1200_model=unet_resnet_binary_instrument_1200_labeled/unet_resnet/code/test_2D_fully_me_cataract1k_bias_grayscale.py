...
parser.add_argument('--image_dir', type=str,
                    default='/Users/mahtab/Downloads/SSL4MIS/segmentation_project/data/bias_data_iris_color/dark_iris_color/test/images',
                    help='Name of Experiment')
parser.add_argument('--label_dir', type=str,
                    default='/Users/mahtab/Downloads/SSL4MIS/segmentation_project/data/bias_data_iris_color/dark_iris_color/test/labels_four_class',
                    help='experiment_name')
parser.add_argument('--exp', type=str,
                    default='/Users/mahtab/Downloads/SSL4MIS/segmentation_project/model/full_supervised_experiment with labeled_num=839_light_iris_grayscale_839_labeled/',
                    help='experiment_name')
...
parser.add_argument('--output_dir', type=str, default='/Users/mahtab/Downloads/SSL4MIS/segmentation_project/model/full_supervised_experiment with labeled_num=839_light_iris_grayscale_839_labeled/output_dark/',
...
def apply_custom_colormap(label, num_classes=3):
    """
...
def visualize_and_save(image, label, prediction, output_path, file_name, num_classes=3):
    """
...
def test_single_image(image_path, label_path, net, output_dir, FLAGS):
    ...
    resized_image = zoom(image, (patch_size / x, patch_size / y), order=0)
    ...
    input_tensor = np.repeat(input_tensor[..., np.newaxis], 3, -1)
