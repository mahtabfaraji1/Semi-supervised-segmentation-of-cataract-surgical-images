...
transforms_1 = torch.nn.Sequential(
    # v1.RandomCrop(224),
    # v1.ColorJitter(brightness=.5, hue=.3),
    v1.GaussianBlur(kernel_size=(5, 5))
...
def train():
    ...
    for ramp_up in ramp_up_list:
        ...
        exp = f"experiment with ema_decay={ema_decay}, ramp_up={ramp_up},consistency_weight={consistency},wait_period={wait_period},labeled={labeled_num}, unlabeled={unlabeled_num}_cadis_v2"
        print(exp)
