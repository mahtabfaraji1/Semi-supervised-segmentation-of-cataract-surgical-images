...
parser.add_argument('--image_dir', type=str,
                    default='/Users/mahtab/Downloads/SSL4MIS/segmentation_project/data/Catarac1k/cataract1k_patient_wise/case_5013_labeled/test/images',
                    help='Name of Experiment')
parser.add_argument('--label_dir', type=str,
                    default='/Users/mahtab/Downloads/SSL4MIS/segmentation_project/data/Catarac1k/cataract1k_patient_wise/case_5013_labeled/test/labels',
                    help='experiment_name')
parser.add_argument('--exp', type=str,
                    default='/Users/mahtab/Downloads/SSL4MIS/segmentation_project/model/Cataract1k/1000_labeled_fully_supervised/full_supervised_experiment with base_lr=0.01, batch_size=24,labeld_num=1000_1000_labeled/',
                    help='experiment_name')
...
parser.add_argument('--output_dir', type=str, default='/Users/mahtab/Downloads/SSL4MIS/segmentation_project/model/Cataract1k/1000_labeled_fully_supervised/full_supervised_experiment with base_lr=0.01, batch_size=24,labeld_num=1000_1000_labeled/output/',
