...
root_path = '/home/mahtab/segmentation/SSL4MIS/segmentation_env/data/CaDis/200_labeled_data_semisupervised/'
...
def train():
    ...
    for ramp_up in ramp_up_list:
        ...
        exp = f"experiment with ema_decay={ema_decay}, ramp_up={ramp_up},consistency_weight={consistency},wait_period={wait_period},labeled={labeled_num}, unlabeled={unlabeled_num}_cadis"
        print(exp)
