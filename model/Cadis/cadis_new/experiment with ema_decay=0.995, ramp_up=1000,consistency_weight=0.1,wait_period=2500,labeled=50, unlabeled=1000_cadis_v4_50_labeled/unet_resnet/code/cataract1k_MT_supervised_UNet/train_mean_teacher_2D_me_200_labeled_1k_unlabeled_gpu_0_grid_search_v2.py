...
root_path = '/home/mahtab/segmentation/SSL4MIS/segmentation_env/data/200_labeled_data_semisupervised/'
...
def train():
    ...
    for ramp_up in ramp_up_list:
        ...
        exp = f"experiment with ema_decay={ema_decay}, ramp_up={ramp_up},consistency_weight={consistency},wait_period={wait_period}_1k_200_labeld"
        print(exp)
