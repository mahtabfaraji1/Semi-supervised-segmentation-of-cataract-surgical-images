...
exp = 'Experiment_labeled_30_per_473_labeled_e30000_v2_consistency_1'
model_name = 'unet'
...
def train():
    ...
    labeled_images_file = open(os.path.join(snapshot_path, 'labeled_images_20_per.txt'), 'w')
    unlabeled_images_file = open(os.path.join(snapshot_path, 'unlabeled_images_20_per.txt'), 'w')
