...
root_path = '/home/mahtab/segmentation/SSL4MIS/segmentation_env/data/Cataract1k/1000_labeled_data_semisupervised_603_same_cases/'
...
def train():
    ...
    for ramp_up in ramp_up_list:
        ...
        exp = f"experiment with ema_decay={ema_decay}, ramp_up={ramp_up},consistency_weight={consistency},wait_period={wait_period}_labeled={labeled_num}_unlabeled={unlabeled_num}_same"
        print(exp)
