...
parser.add_argument('--exp', type=str,
                    default='/Users/mahtab/Downloads/SSL4MIS/segmentation_project/model/Cadis/semi-supervised_1k/experiment with ema_decay=0.995, ramp_up=1000,consistency_weight=0.1,wait_period=2500,labeled=50, unlabeled=1000_cadis_ema_50_labeled/',
                    help='experiment_name')
...
parser.add_argument('--output_dir', type=str, default='/Users/mahtab/Downloads/SSL4MIS/segmentation_project/model/Cadis/semi-supervised_1k/experiment with ema_decay=0.995, ramp_up=1000,consistency_weight=0.1,wait_period=2500,labeled=50, unlabeled=1000_cadis_ema_50_labeled/output/',
