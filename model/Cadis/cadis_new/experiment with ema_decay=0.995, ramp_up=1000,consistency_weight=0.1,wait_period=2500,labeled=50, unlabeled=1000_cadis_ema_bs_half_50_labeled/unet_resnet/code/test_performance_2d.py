...
parser.add_argument('--root_path', type=str, default='/home/mahtab/segmentation/SSL4MIS/segmentation_env/data/cataract1k/all/', help='Patch to dataset')
parser.add_argument('--res_path', type=str, default='./home/mahtab/segmentation/SSL4MIS/segmentation_env/results/AD_MT', help='Path to results')
parser.add_argument('--exp', type=str, default='AD_MT_results_789', help='experiment_name')
parser.add_argument('--model', type=str, default='unet', help='model_name')
parser.add_argument('--num_classes', type=int,  default=5, help='output channel of network')
parser.add_argument('--labeled_num', type=int, default=227, help='labeled data')
