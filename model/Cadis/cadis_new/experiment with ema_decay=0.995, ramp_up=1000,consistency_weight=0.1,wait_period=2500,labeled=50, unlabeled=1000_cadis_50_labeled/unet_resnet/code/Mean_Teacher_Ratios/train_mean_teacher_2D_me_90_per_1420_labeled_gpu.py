...
exp = 'Experiment_labeled_90_per_1420_labeled_e30000'
model_name = 'unet'
...
def train():
    ...
    labeled_images_file = open(os.path.join(snapshot_path, 'labeled_images_90_per.txt'), 'w')
    unlabeled_images_file = open(os.path.join(snapshot_path, 'unlabeled_images_90_per.txt'), 'w')
