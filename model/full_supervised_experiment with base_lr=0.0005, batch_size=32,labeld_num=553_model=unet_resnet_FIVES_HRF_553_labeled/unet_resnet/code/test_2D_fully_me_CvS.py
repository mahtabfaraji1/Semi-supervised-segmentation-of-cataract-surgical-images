...
parser.add_argument('--exp', type=str,
                    default='/Users/mahtab/Downloads/SSL4MIS/segmentation_project/model/full_supervised_experiment with base_lr=0.01, batch_size=32,labeld_num=553_model=unet_resnet_FIVES_HRF_553_labeled/',
                    help='experiment_name')
...
parser.add_argument('--output_dir', type=str, default='/Users/mahtab/Downloads/SSL4MIS/segmentation_project/model/full_supervised_experiment with base_lr=0.01, batch_size=32,labeld_num=553_model=unet_resnet_FIVES_HRF_553_labeled/output_hrf_fives/',
