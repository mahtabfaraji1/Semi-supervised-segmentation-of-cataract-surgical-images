...
parser.add_argument('--root_path', type=str,
                    default='/home/mahtab/segmentation/SSL4MIS/segmentation_env/data/cataract1k/40_perc/', help='Name of Experiment')
parser.add_argument('--exp', type=str,
                    default='Exp_supervised_Unet_40_percent_v_2_r2', help='experiment_name')
...
parser.add_argument('--labeled_num', type=int, default=631,
                    help='labeled data')
