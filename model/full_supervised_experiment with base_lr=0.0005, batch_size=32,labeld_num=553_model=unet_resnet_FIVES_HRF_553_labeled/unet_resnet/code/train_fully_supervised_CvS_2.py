...
parser.add_argument('--root_path', type=str,
                    default='/Users/mahtab/Downloads/SSL4MIS/segmentation_project/data/CVS_data/all_data/',
                    help='Name of Experiment')
# parser.add_argument('--root_path', type=str,
#                     default='/home/mahtab/segmentation/SSL4MIS/segmentation_env/data/CVS_data/all_data/',
#                     help='Name of Experiment')
parser.add_argument('--exp', type=str,
                    default='Exp_supervised_unet_resnet_FIVES_HRF', help='experiment_name')
...
parser.add_argument('--labeled_num', type=int, default=553,
                    help='labeled data')
...
def train(args):
    ...
    exp = f"full_supervised_experiment with base_lr={base_lr}, batch_size={batch_size},labeld_num={args.labeled_num}_model={args.model}_FIVES_HRF"
    print(exp)
    ...
    wait = 0
    lr_scheduler = optim.lr_scheduler.CosineAnnealingLR(optimizer, T_max=max_epoch, eta_min=0)
    for epoch_num in iterator:
        epoch_num = epoch_num + 1
        print('\nEPOCH: %d/%d --(learn_rate:%.6f) | Time: %s' % \
              (epoch_num, max_epoch, optimizer.state_dict()['param_groups'][0]['lr'], time.asctime()))
