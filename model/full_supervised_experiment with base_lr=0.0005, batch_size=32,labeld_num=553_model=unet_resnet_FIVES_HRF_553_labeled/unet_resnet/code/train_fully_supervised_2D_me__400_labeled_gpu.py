...
parser.add_argument('--root_path', type=str,
                    default='/home/mahtab/segmentation/SSL4MIS/segmentation_env/data/Cataract1k/400_labeled_data_supervised/', help='Name of Experiment')
parser.add_argument('--exp', type=str,
                    default='Exp_supervised_Unet_400_labeled_deeplabv3_resnet', help='experiment_name')
