...
parser.add_argument('--exp', type=str,
                    default='/Volumes/ADATA HD720/PhD_UIC/SSL4MIS/segmentation_project/model/experiment with labeled=100, unlabeled=40042_ema_decay=0.99_consistency_0.1_ramp_up_50_wait_period_3500_cataract1k_v4_model=deeplabv3_resnet_100_labeled/',
                    help='experiment_name')
...
parser.add_argument('--output_dir', type=str, default='/Volumes/ADATA HD720/PhD_UIC/SSL4MIS/segmentation_project/model/experiment with labeled=100, unlabeled=40042_ema_decay=0.99_consistency_0.1_ramp_up_50_wait_period_3500_cataract1k_v4_model=deeplabv3_resnet_100_labeled/output',
