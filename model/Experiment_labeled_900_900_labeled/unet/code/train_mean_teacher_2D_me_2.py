...
root_path = '/Users/mahtab/Downloads/SSL4MIS/segmentation_env/data/cataract1k/labeled/'
exp = 'Experiment_labeled_900'
model_name = 'unet'
max_iterations = 1000
batch_size = 24
deterministic = 1
...
def train():
    ...
    def create_model(ema=False):
        model = net_factory(net_type=model_name, in_chns=1, class_num=num_classes, device=device)
